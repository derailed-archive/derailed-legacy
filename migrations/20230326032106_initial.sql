...
CREATE TABLE IF NOT EXISTS guilds (
    ...
    flags int NOT NULL,
    owner_id bigint NOT NULL FOREIGN KEY REFERENCES users(id) ON DELETE NO ACTION,
...
CREATE TABLE IF NOT EXISTS channels (
    ...
    parent_id bigint FOREIGN KEY REFERENCES channels(id) ON DELETE SET NULL,
    guild_id bigint FOREIGN KEY REFERENCES guilds(id) ON DELETE CASCADE,
    position int
);

CREATE TABLE IF NOT EXISTS invites (
    id text PRIMARY KEY,
    guild_id bigint NOT NULL FOREIGN KEY REFERENCES guilds(id) ON DELETE CASCADE,
    author_id bigint NOT NULL FOREIGN KEY REFERENCES users(id) ON DELETE SET NULL,
    channel_id bigint NOT NULL FOREIGN KEY REFERENCES channels(id) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS member_assigned_roles (
    ...
    user_id bigint NOT NULL FOREIGN KEY members(user_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS messages (
    id bigint PRIMARY KEY,
    channel_id bigint NOT NULL FOREIGN KEY channels(id) ON DELETE CASCADE,
    author_id bigint NOT NULL FOREIGN KEY users(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS read_states (
    ...
    channel_id bigint NOT NULL FOREIGN KEY channels(ids) ON DELETE CASCADE,
    last_message_id bigint
);
